...
__Note:__ the number after the decimal point gives the original position in the vector.
...
Because matrices and arrays are implemented as vectors with special attributes, you can also subset them with a single vector, in which case they will behave like a vector. Arrays in R are stored in column-major order:
